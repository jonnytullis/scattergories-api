/**
 * This is a string template that is just passes the string thru. It's purpose is so that extensions can color code
 * graphQL types and aid in development.
 *
 * Apollo-server also has this functionality, but we choose to defer it's usage until the Apollo-server actually needs it.
